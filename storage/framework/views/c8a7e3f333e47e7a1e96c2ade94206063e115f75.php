...
<head>
    ...
    <title><?php echo e(config('app.name', 'Twitter Clone App')); ?></title>
        ...
        <nav class="w-full fixed flex items-center h-16 bg-blue-500 py-6 select-none z-10">
            <div class="container mx-auto px-6 md:px-0">
                <div class="flex items-center justify-center">
                    <div class="ml-20">
                        <a href="<?php echo e(url('/tweets')); ?>" class="text-lg font-semibold text-white no-underline">
                    ...
                    <div class="flex-1 text-right mr-6 ">
                        <?php if(auth()->guard()->guest()): ?>
                            <a class="mr-3 px-3 py-2 bg-green-600 text-white hover:text-green-200 focus:bg-green-800 text-sm rounded-md focus:outline-none font-bold" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                            <?php if(Route::has('register')): ?>
                                <a class="px-3 py-2 bg-indigo-600 text-white hover:text-indigo-200 focus:bg-indigo-800 text-sm rounded-md focus:outline-none font-bold" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a>
                            <?php endif; ?>
                        <?php else: ?>
...
<?php /**PATH /home/mohamed/Desktop/laravel/laravel-twitter-clone/resources/views/layouts/app.blade.php ENDPATH**/ ?>